...
export function PreferencesPart(props: {
  ...
  const handleSpatialNavigationToggle = () => {
    props.setEnableSpatialNavigation(!props.enableSpatialNavigation);
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div
              onClick={handleSpatialNavigationToggle}
              className="bg-dropdown-background hover:bg-dropdown-hoverBackground select-none my-4 cursor-pointer space-x-3 flex items-center max-w-[25rem] py-3 px-4 rounded-lg"
            >
              <Toggle enabled={props.enableSpatialNavigation} />
              <p className="flex-1 text-white font-bold">
